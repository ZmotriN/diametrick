...
<table class="form large">
    <thead>
        <tr>
            <th colspan="2"><div class="icon inbox" title="Messages reçus"></div>Messages envoyés<div class="icon send" title="Envoyer un message"></div></th>
        </tr>
    </thead>
    <tbody>
        <tr>
...
<div id="modal_message" class="modalform">
...
<script><?php $this->includejs('messages/messages_outbox'); ?>app.init(<?php echo json_encode($params); ?>);</script>